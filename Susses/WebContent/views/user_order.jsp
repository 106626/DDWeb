			...
			<div class="container">
				<div class="row">
					<div class="col-md-2 col-sm-3 col-xs-6">
						<div class="logo">
							<a href="index.jsp"><img src="/Susses/img/logo/logo.png"
								alt=""></a>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="breadcurbs-inner text-center">
							<h3 class="breadcrubs-title">Our Order</h3>
							<ul>
								<li><a href="index.jsp">home <span>//</span>
								</a></li>
								<li>Order</li>
							</ul>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="single-footer instagram">
								...
								<div class="single-footer-details mt-30"></div>
							</div>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-12">
